...
void Skybox::initialize() {
    ...
    glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X, 0, GL_RGBA, m_image1.width(), m_image1.height(), 0, GL_RGBA, GL_UNSIGNED_BYTE, m_image1.bits());
    ...
    glTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_X, 0, GL_RGBA, m_image2.width(), m_image2.height(), 0, GL_RGBA, GL_UNSIGNED_BYTE, m_image2.bits());
    ...
    glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_Y, 0, GL_RGBA, m_image3.width(), m_image3.height(), 0, GL_RGBA, GL_UNSIGNED_BYTE, m_image3.bits());
    ...
    glTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_Y, 0, GL_RGBA, m_image4.width(), m_image4.height(), 0, GL_RGBA, GL_UNSIGNED_BYTE, m_image4.bits());
    ...
    glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_Z, 0, GL_RGBA, m_image5.width(), m_image5.height(), 0, GL_RGBA, GL_UNSIGNED_BYTE, m_image5.bits());
    ...
    glTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_Z, 0, GL_RGBA, m_image6.width(), m_image6.height(), 0, GL_RGBA, GL_UNSIGNED_BYTE, m_image6.bits());
